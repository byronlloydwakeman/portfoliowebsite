...
const NavigationBar = () => {
    return(
        <div className="navigation-bar__container">
            <Link className="navigation-bar__link" to="portfoliowebsite/Home">
                <div onClick={() => 
                {
                    Animation("home");
            ...
            <Link className="navigation-bar__link" to="portfoliowebsite/About">
                <div onClick={() => 
                {
                    Animation("about");
            ...
            <Link className="navigation-bar__link" to="portfoliowebsite/Experience">
                <div onClick={() => 
                {
            ...
            <Link className="navigation-bar__link" to="portfoliowebsite/Work">
                <div onClick={() => 
                {
                    Animation("work");
            ...
            <Link className="navigation-bar__link" to="portfoliowebsite/Contact">
                <div onClick={() => 
                {
                    Animation("contact");
